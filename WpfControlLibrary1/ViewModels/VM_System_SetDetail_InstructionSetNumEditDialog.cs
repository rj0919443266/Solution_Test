...
{
    public partial class VM_System_SetDetail_InstructionSetNumEditDialog : ObservableObject
    {
        ...
        public VM_System_SetDetail_InstructionSetNumEditDialog(InstructionSetRemarkModel? target = null)
        {
            if (target != null)
            {
                DialogTitle = "修改異常單項目";
        ...
        private void ConfirmSave()
        {
            ...
            var resultModel = new InstructionSetRemarkModel
            {
